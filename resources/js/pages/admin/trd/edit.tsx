...
export default function AdminTRDEdit({ trd, estados, tieneDocumentosAsociados }: Props) {
    const [form, setForm] = useState({
        codigo: trd.codigo || '',
        nombre: trd.nombre || '',
        descripcion: trd.descripcion || '',
        justificacion: trd.justificacion || '',
        version: trd.version || '',
        estado: trd.estado || 'borrador',
        vigente: trd.vigente || false,
        formato_archivo: trd.formato_archivo || 'XML',
        metadatos_asociados: trd.metadatos_asociados ? JSON.stringify(trd.metadatos_asociados, null, 2) : ''
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(`/admin/trd/${trd.id}`, formData, {
            onError: (errors) => {
                setErrors(errors);
                setProcessing(false);
            },
    ...
    return (
        <AppLayout breadcrumbItems={breadcrumbItems}>
            <Head title={`Editar TRD: ${trd.nombre} - Tablas de Retención Documental`} />
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Editar TRD</h1>
                            <p className="text-gray-600 mt-1">Modificar información de la Tabla de Retención Documental</p>
                        </div>
                    </div>
                ...
                <Card className="bg-gray-50 border-gray-200">
                    <CardContent className="pt-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div>
                                <span className="font-medium text-gray-700">ID Único:</span>
                                <p className="text-gray-600 font-mono">{trd.identificador_unico}</p>
                            </div>
                            <div>
                                <span className="font-medium text-gray-700">Creado:</span>
                                <p className="text-gray-600">{formatDate(trd.created_at)}</p>
                                {trd.creador && (
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">{formatDate(trd.fecha_actualizacion)}</p>
                                {trd.modificador && (
                ...
                {tieneDocumentosAsociados && (
                    <Alert className="border-yellow-200 bg-yellow-50">
                        ...
                        <AlertDescription className="text-yellow-800">
                            <strong>Atención:</strong> Esta TRD tiene documentos asociados. Algunos cambios pueden requerir 
                            análisis de impacto antes de ser aplicados.
                        </AlertDescription>
                    </Alert>
                )}
                ...
                {trd.fecha_aprobacion && (
                    <Alert className="border-blue-200 bg-blue-50">
                        <AlertDescription className="text-blue-800">
                            <strong>TRD Aprobada:</strong> Aprobada el {formatDate(trd.fecha_aprobacion)}. 
                            Los cambios de estado requieren autorización especial.
                        </AlertDescription>
                    </Alert>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Justifique la modificación de esta TRD"
                                    rows={3}
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Modifique el estado y configuraciones técnicas
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        ...
                                        disabled={form.estado !== 'aprobada' && !form.vigente}
                                    />
                                    <Label htmlFor="vigente" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                                        Marcar como vigente
                                    </Label>
                                </div>
                                {form.estado !== 'aprobada' && !trd.vigente && (
                                    <p className="text-xs text-gray-500">
                                        Solo las TRDs aprobadas pueden marcarse como vigentes
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-gray-500">
                                    Opcional: Metadatos adicionales en formato JSON válido
                                </p>
                ...
                <Card className="bg-blue-50 border-blue-200">
                    <CardContent className="pt-6">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-medium text-blue-900 mb-2">Notas importantes sobre la edición</h3>
                                <ul className="text-sm text-blue-800 space-y-1">
                                    <li>• Los cambios en TRDs aprobadas pueden requerir re-aprobación</li>
                                    <li>• El código debe mantenerse único en el sistema</li>
                                    <li>• Los cambios de estado siguen el flujo: borrador → revisión → aprobada → vigente</li>
                                    <li>• TRDs con documentos asociados requieren análisis de impacto</li>
                                    <li>• La fecha de actualización se registra automáticamente</li>
                                </ul>
                            </div>
                        </div>
                    </CardContent>
